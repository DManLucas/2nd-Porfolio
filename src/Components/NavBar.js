  ...
  return (
    <>
      <Link href={href} className={`${className} relative group`}>
        ...
        group-hover:w-full transition-[width] ease duration-700
...
function NavBar() {
  ...
  return (
    ...
    relative z-30 lg:px-16 md:px-12 sm:px-8"
    >
      <button
      ...
      >
        <nav>
          ...
          {/* <Link href='/articles' title="Articles" className="ml-4"/>*/}
        </nav>

        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://github.com/DManLucas"
            className="w-6 mr-3"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://www.linkedin.com/in/mphubelunakeli/"
            className="w-6 mr-3"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
      ...
      {isOpen ? (
        <motion.div
          ...
          className="min-w-[70vw] flex flex-col justify-between
            items-center fixed top-1/2 left-1/2 z-10
            -translate-x-1/2 -translate-y-1/2 bg-dark/90 
           dark:bg-light/75 rounded-lg backdrop-blur-md 
            py-32 duration-300"
        >
          ...
          >
            ...
            >
              ...
              dark:bg-dark dark:rounded-full"
              />
            </motion.a>
            <motion.a
              href="https://www.linkedin.com/in/mphubelunakeli/"
